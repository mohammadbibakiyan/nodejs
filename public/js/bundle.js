        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "loged in successfully "), window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _alert.showAlert)("error", "error in log");
...
exports.login = login;
},{"./alert.js":"alert.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibW9oYW1tYWRiaWJha2l5YW4iLCJhIjoiY2w1NmNpZmEyMHZ6dzNxcGJvZm8wdHZpayJ9.iug42z1XPTT_Z0aq2xVTzA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/mohammadbibakiyan/cl56i1uim000d14ptaoh3gw4r',
    // style URL
    center: [-74.5, 40],
...
if (form) {
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.querySelector('#email.form__input').value;
    var password = document.querySelector('#password.form__input').value;
